...
libmain(int argc, char **argv)
{
  ...
  800076:	a3 60 40 80 00       	mov    %eax,0x804060
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001fe:	0f be 80 51 10 80 00 	movsbl 0x801051(%eax),%eax
  800205:	50                   	push   %eax
...
00800255 <vprintfmt>:
{
  ...
  8002a5:	3e ff 24 85 20 11 80 	notrack jmp *0x801120(,%eax,4)
  8002ac:	00 
  ...
  800372:	8b 14 85 80 12 80 00 	mov    0x801280(,%eax,4),%edx
  800379:	85 d2                	test   %edx,%edx
  80037b:	74 18                	je     800395 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  80037d:	52                   	push   %edx
  80037e:	68 72 10 80 00       	push   $0x801072
  800383:	53                   	push   %ebx
  800384:	56                   	push   %esi
  ...
  800395:	50                   	push   %eax
  800396:	68 69 10 80 00       	push   $0x801069
  80039b:	53                   	push   %ebx
  80039c:	56                   	push   %esi
  ...
  8003bd:	b8 62 10 80 00       	mov    $0x801062,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b47:	68 a4 12 80 00       	push   $0x8012a4
  800b4c:	6a 23                	push   $0x23
  800b4e:	68 c1 12 80 00       	push   $0x8012c1
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bd4:	68 a4 12 80 00       	push   $0x8012a4
  800bd9:	6a 23                	push   $0x23
  800bdb:	68 c1 12 80 00       	push   $0x8012c1
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c1a:	68 a4 12 80 00       	push   $0x8012a4
  800c1f:	6a 23                	push   $0x23
  800c21:	68 c1 12 80 00       	push   $0x8012c1
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c60:	68 a4 12 80 00       	push   $0x8012a4
  800c65:	6a 23                	push   $0x23
  800c67:	68 c1 12 80 00       	push   $0x8012c1
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cec:	68 a4 12 80 00       	push   $0x8012a4
  800cf1:	6a 23                	push   $0x23
  800cf3:	68 c1 12 80 00       	push   $0x8012c1
...
sys_ipc_recv(void *dstva)
{
  ...
  800d58:	68 a4 12 80 00       	push   $0x8012a4
  800d5d:	6a 23                	push   $0x23
  800d5f:	68 c1 12 80 00       	push   $0x8012c1
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d89:	56                   	push   %esi
  800d8a:	50                   	push   %eax
  800d8b:	68 d0 12 80 00       	push   $0x8012d0
  ...
  800d9c:	e8 5c f3 ff ff       	call   8000fd <vcprintf>
	cprintf("\n");
  800da1:	c7 04 24 f3 12 80 00 	movl   $0x8012f3,(%esp)
