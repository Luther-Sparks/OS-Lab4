...
umain(int argc, char **argv)
{
  ...
  800041:	e8 68 00 00 00       	call   8000ae <sys_cputs>
}
...
libmain(int argc, char **argv)
{
  ...
  80005a:	e8 d9 00 00 00       	call   800138 <sys_getenvid>
	thisenv = envs + ENVX(envid);
  80005f:	25 ff 03 00 00       	and    $0x3ff,%eax
  800064:	69 c0 84 00 00 00    	imul   $0x84,%eax,%eax
  80006a:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  80006f:	a3 60 40 80 00       	mov    %eax,0x804060

	// save the name of the program so that panic() can use it
	if (argc > 0)
  800074:	85 db                	test   %ebx,%ebx
  800076:	7e 07                	jle    80007f <libmain+0x34>
		binaryname = argv[0];
